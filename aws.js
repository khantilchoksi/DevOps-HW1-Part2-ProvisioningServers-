...
var securityGroupId;
var keyValuePair;
var securityGroupName = 'DevOpsSecurityGroup';//MySecurityGroup
var keyName = 'DevOps_KeyPair';//DevOpsKeyPair
var vmName = 'AWSProvisionedServer';//ProvisionedServer


//Creating Security Group
var paramsSecurityGroup = {
    Description: 'MySecurityGroup DevOps', // required 
  ...
  ec2.describeInstances(params, function(err, data) {
    if (err) console.log(err, err.stack); // an error occurred
        ...
        for(var i=0,ilen=reservation.Instances.length; i<ilen; ++i) {
            ...
            var inventoryEntry = instance.PublicDnsName+' ansible_ssh_user=ubuntu '+'ansible_ssh_private_key_file=/home/vagrant/keys/'+keyName+'.pem'+'\n';
            //[AppServer]
...
//  });
  ...
  //let buffer = new Buffer(inventoryEntry);
...
// meta.request("/latest/meta-data/i-0b787e7059e6fa512", function(err, data){
